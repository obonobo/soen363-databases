...
SELECT M1.mid , M2.mid , (CAST(N2.commonActor AS float)/CAST(N1.actorsCount AS float)) AS diff
...
SELECT M1.mid, M2.mid, count(TT1.tag) AS commonTag
...
SELECT M1.mid , M2.mid , (CAST(N2. commonTag AS float)/CAST(N1.tagCount AS float)) AS diff
...
SELECT M1.mid , M2.mid , (CAST(N2.commonGenre AS float)/CAST(N1.genreCount AS float)) AS diff
